...
**Engineering Alpha — Lab Use Only.**

Trareon Acquire is a digital forensic acquisition tool under active
development. The current milestone (M0) is a **file-backed foundation
slice**: streaming acquisition of a synthetic/file source, SHA-256 hashing,
an append-only hash-chained audit journal, `.fsnap` packaging, and an
independent CLI verifier.

It is **not** validated for production evidence on real devices. Capability
without exact hardware evidence remains `NotValidated`.
...
| [`docs/fsnap-v0.1-read-contract.md`](docs/fsnap-v0.1-read-contract.md) | `.fsnap` v0.1 reader/verifier contract |
...
A fuller user-guide / About / legal-limitations package is planned as
**Day 28** in the Month-01 AI operations runbook — this README is an interim
landing page until that lands.
