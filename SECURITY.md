...
list — mostly transitive Slint / image / Wayland stack notes (unmaintained
crates or XML parsers not fed untrusted input by Acquire).

The former Tauri + GTK3/`glib` Dependabot alert is **resolved by removing
Tauri from the workspace** (Slint is the desktop shell). Historical note:
https://github.com/Trareon-com/Trareon-Acquire/security/dependabot/1
