...
| macOS allowlisted bounded raw sample | Lab smoke PASS | `disk10`/`rdisk10` tiny11 USB; 1 MiB + 64 MiB `max_bytes`; report `m2-lab-tiny11-2311-disk10.md` | Full-disk NotValidated; NTFS volume RO; not Lab Beta exit |
