...
| 25 | macOS feasibility | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | M4 Pro real HW | See platform report | docs/platform/day25-macos-feasibility.md | IMPLEMENTED_UNREVIEWED | REQUIRED_FOR_DEVICE resolved |
