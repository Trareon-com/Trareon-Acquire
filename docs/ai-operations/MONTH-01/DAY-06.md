...
Scope file/interface: crates/traeron-core/src/audit.rs; crates/traeron-core/tests/audit.rs; docs cryptographic profile.
...
Verification wajib: cargo test -p traeron-core --test audit -- --nocapture; cargo fmt --all -- --check.
...
- Expected files/interfaces: crates/traeron-core/src/audit.rs; crates/traeron-core/tests/audit.rs; docs cryptographic profile.
...
- Verification: `cargo test -p traeron-core --test audit -- --nocapture; cargo fmt --all -- --check`.
...
Jalankan command aman yang relevan: cargo test -p traeron-core --test audit -- --nocapture; cargo fmt --all -- --check. Bandingkan exact local/remote/PR/CI SHA bila remote evidence tersedia. SHA mismatch adalah BLOCKED + REMOTE-STATE-DIVERGENCE. Hasil tanpa reproducible evidence adalah UNVERIFIED.
