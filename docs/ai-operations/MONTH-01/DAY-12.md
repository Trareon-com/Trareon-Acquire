...
Scope file/interface: schemas/fsnap-manifest-v1.schema.json; crates/trareon-core/src/package.rs; crates/trareon-core/tests/package.rs.
...
Verification wajib: cargo test -p trareon-core --test package; cargo test --workspace --all-targets.
...
- Expected files/interfaces: schemas/fsnap-manifest-v1.schema.json; crates/trareon-core/src/package.rs; crates/trareon-core/tests/package.rs.
...
- Verification: `cargo test -p trareon-core --test package; cargo test --workspace --all-targets`.
...
Jalankan command aman yang relevan: cargo test -p trareon-core --test package; cargo test --workspace --all-targets. Bandingkan exact local/remote/PR/CI SHA bila remote evidence tersedia. SHA mismatch adalah BLOCKED + REMOTE-STATE-DIVERGENCE. Hasil tanpa reproducible evidence adalah UNVERIFIED.
