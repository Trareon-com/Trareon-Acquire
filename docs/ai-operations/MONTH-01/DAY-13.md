...
Scope file/interface: crates/trareon-core/src/package.rs; crates/trareon-core/tests/package.rs; schemas/fsnap-manifest-v1.schema.json.
...
Verification wajib: cargo test -p trareon-core --test package -- --nocapture.
...
- Expected files/interfaces: crates/trareon-core/src/package.rs; crates/trareon-core/tests/package.rs; schemas/fsnap-manifest-v1.schema.json.
...
- Verification: `cargo test -p trareon-core --test package -- --nocapture`.
...
Jalankan command aman yang relevan: cargo test -p trareon-core --test package -- --nocapture. Bandingkan exact local/remote/PR/CI SHA bila remote evidence tersedia. SHA mismatch adalah BLOCKED + REMOTE-STATE-DIVERGENCE. Hasil tanpa reproducible evidence adalah UNVERIFIED.
