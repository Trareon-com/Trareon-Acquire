# Day 15 — Verifier CLI dan fsnap v0.1 draft

## Outcome

Tambahkan CLI round-trip dan golden packages valid, mutated, truncated, removed-file, audit-discontinuous, unsupported-version; tulis read contract v0.1 draft.

## Entry Gate

- Prasyarat: Day 14 dengan independent review EXPECTED_PASS.
- Project root: `/Users/user/Projects/Trareon/Trareon Acquire`.
- Branch: `feat/m0-d15-contract`; satu author dan satu worktree aktif.
...
- [ ] Pastikan Issue Day 15 berada di status yang benar dan tidak ada Day lain menulis file yang sama.
...
```text
Anda adalah independent reviewer Claude Code untuk M0-D15. Jangan menulis pada worktree author. Baca RFC, active runbook, commit_before, frozen commit_after, diff, test logs, dan local evidence.
...
Jika semua exit checklist lulus, handoff ke `DAY-16.md` dengan frozen SHA, TaskResult.v1 author/reviewer/Antigravity, CI/platform evidence, incident/recovery count, dan remaining risks. Selain itu tetap pada Day 15.
