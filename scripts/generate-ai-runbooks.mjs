...
const days = [
  ...
  [2,"M0-D02","Workspace dan core boundary","Claude Code","Codex","Medium","AUTO_WITH_REVIEW","feat/m0-d02-workspace","Buat Rust workspace, traeron-core boundary, build identity, dan failing public-boundary test sesuai Foundation Plan Task 1.","Cargo.toml; crates/traeron-core/Cargo.toml; crates/traeron-core/src/lib.rs; crates/traeron-core/tests/foundation.rs","cargo test --workspace --all-targets; cargo fmt --all -- --check; cargo clippy --workspace --all-targets -- -D warnings","core bebas Tauri/frontend, dependency exact, failing test dibuktikan sebelum implementasi","NO_RUN_NOT_VISUAL"],
  [3,"M0-D03","Domain identifiers dan capability types","Claude Code","Codex","High","AUTO_WITH_REVIEW","feat/m0-d03-domain","Implementasikan ID, capability state, acquisition status, dan error/result types dari Foundation Plan Task 2 dengan serialization tests.","crates/traeron-core/src/domain.rs; crates/traeron-core/src/lib.rs; crates/traeron-core/tests/domain.rs","cargo test -p traeron-core --test domain; cargo test --workspace --all-targets","type tidak ambigu, unsupported capability eksplisit, tidak ada status complete palsu","NO_RUN_NOT_VISUAL"],
  [4,"M0-D04","State transition engine","Claude Code","Codex","High","AUTO_WITH_REVIEW","feat/m0-d04-state","Lengkapi allowed transition table dan negative tests untuk invalid, cancel, fail, incomplete, verification, serta terminal states.","crates/traeron-core/src/domain.rs; crates/traeron-core/tests/domain.rs","cargo test -p traeron-core --test domain; cargo test --workspace --all-targets","semua forbidden transition fail-closed dan terminal state tidak dapat dimutasi","NO_RUN_NOT_VISUAL"],
  [5,"M0-D05","Append-only audit hash chain","Claude Code","Codex","High","AUTO_WITH_REVIEW","feat/m0-d05-audit","Implementasikan audit events dan hash chain dari Foundation Plan Task 3 dengan mutation, removal, reorder, dan discontinuity tests.","crates/traeron-core/src/audit.rs; crates/traeron-core/src/lib.rs; crates/traeron-core/tests/audit.rs","cargo test -p traeron-core --test audit; cargo test --workspace --all-targets","canonical event bytes, previous-hash continuity, tamper selalu terdeteksi","NO_RUN_NOT_VISUAL"],
  [6,"M0-D06","Canonical serialization dan hashing","Claude Code","Codex","High","AUTO_WITH_REVIEW","feat/m0-d06-canonical","Bekukan canonical field ordering/version profile dan buktikan repeated-run equality, changed-field inequality, serta unsupported-version failure.","crates/traeron-core/src/audit.rs; crates/traeron-core/tests/audit.rs; docs cryptographic profile","cargo test -p traeron-core --test audit -- --nocapture; cargo fmt --all -- --check","deterministik lintas repeated run; tidak mengandalkan map iteration atau locale/timezone","NO_RUN_NOT_VISUAL"],
